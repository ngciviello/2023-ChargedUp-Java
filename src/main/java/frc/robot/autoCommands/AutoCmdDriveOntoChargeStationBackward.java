...
public class AutoCmdDriveOntoChargeStationBackward extends CommandBase {
    ...
    public AutoCmdDriveOntoChargeStationBackward(SubDriveTrain subDriveTrain, Timer timer) {
    ...
    public void execute() {
        ...
        if(!onChargeStation && (currentPitch > levelPitchValue-4) && (currentPitch < levelPitchValue + 5)) {
            speed = 0.6;
        }
        else {
            if(!onChargeStation) {
